...
- ![Example Image]([images/example.png](https://github.com/AmirSamanMirjalili/Yoga_Pose_Detection/blob/master/result1.PNG))
- ![Example Image]([images/example.png](https://github.com/AmirSamanMirjalili/Yoga_Pose_Detection/blob/master/result2.PNG))
## Conclusion
